		...
		<div class="row">
				...
				<div id="carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" style="height: 350px" src="/pic/8.jpg" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" style="height: 350px" src="/pic/5.jpg" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" style="height: 350px" src="/pic/7.jpg" alt="Third slide">
						</div>
					</div>
			...
			<div class="col-md-3">
				<div class="card">
				 ...
				 <div class="card">
					<div class="card-header">最多评论文章</div>
					<div class="card-body">
						<ol>
							<c:forEach items="${listCount}" var="article">
				...
				<div class="card">
					<div class="card-header">最多点击文章</div>
					<div class="card-body">
						<ol>
							<c:forEach items="${listHits}" var="article">
								<li class="text-truncate"><a href="/article/getDetail?aId=${article.id}">${article.title}</a></li>
							</c:forEach>
						</ol>
					</div>
